...
module Bundler
 ...
 dir = File.dirname(file)
  ...
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/dm-ar-finders-0.10.2/bin")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/dm-ar-finders-0.10.2/lib")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/rails_dm_datastore-0.2.2/bin")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/rails_dm_datastore-0.2.2/lib")
